...
public class ProWrongsAdapter extends BaseAdapter {
    private List<Q_SingleChoose> list;
    private List<Integer> listid;
    private Context context;
    public ProWrongsAdapter(List<Q_SingleChoose> list ,List<Integer> listid, Context context){
        this.list=list;
        this.listid=listid;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView==null){
            convertView = LayoutInflater.from(WrongActivity.getContext()).inflate(R.layout.contents_view,parent,false);
